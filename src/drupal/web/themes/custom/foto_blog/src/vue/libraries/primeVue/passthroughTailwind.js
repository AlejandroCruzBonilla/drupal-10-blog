...
export const button = {
	root: ({ props, context }) => ({
		class: [
			...
			// Severity not Text not Outline not Plain
			{
			...
			//Outline Severity not Plain
			{
				'btn--primary-outline': props.outlined && props.severity === null && !props.plain,
				'text-blue-500 dark:text-blue-400 border border-blue-500 dark:border-blue-400 hover:bg-blue-300/20': props.outlined && props.severity === 'info' && !props.plain,
			...
			//Size
			{ 'text-xs py-2 px-3': props.size === 'small', 'text-xl py-3 px-4': props.size === 'large' },
